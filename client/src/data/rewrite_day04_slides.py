...
SLIDES = [
    ...
    # ── Slide 7: Costmaps Turn Space into Risk ── (was Slide 8  --  SLAM slide 7 excluded)
    {
        ...
        "board_data": [
            ...
            {"label": bold("Human Supervision Zone"), "value": "Areas where sensor confidence is low and human judgment is required. The operator decides whether the path is safe — the costmap advises, not guarantees."},
        ],
...
new_content = new_content.replace(old_eyebrow, new_eyebrow)
...
new_content = new_content.replace(old_thesis, new_thesis)

# Replace rules
old_rules_start = new_content.index('    "rules": [', new_content.index('DAY04'))
...
# Replace pacing
old_pacing_start = new_content.index('    "pacing": [', new_content.index('DAY04'))
