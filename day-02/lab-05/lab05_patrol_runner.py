#!/usr/bin/env python3
"""
Lab 5 (Day 2) — Patrol + per-checkpoint camera capture + run folder.

Combines Lab 2–4 skills (avoid legs + capture). Writes a full Day 2 deliverable tree.

Usage:
  python course/student/day-02/lab-05/lab05_patrol_runner.py en6 --dry-run
  python course/student/day-02/lab-05/lab05_patrol_runner.py en6
  python course/student/day-02/lab-05/lab05_patrol_runner.py en6 --plan ../lab-04/patrol_plan.cone_course.json
  python course/student/day-02/lab-05/lab05_patrol_runner.py en6 --out-dir ./run_team_a -y --validate
"""
...
DEFAULT_PLAN = _DAY02 / "lab-04" / "patrol_plan.cone_course.json"
...
def main() -> int:
    ...
    print()
    print("Summary: PASS — Lab 5 patrol run folder ready")
    print(f"  ls {run_dir}")
    print(f"  python course/student/day-02/lab-01/lab01_validate_run_folder.py {run_dir}")
    return 0
