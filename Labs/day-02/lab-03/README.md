...
```bash
python course/day-02/lab-03/lab03_capture_inspection.py en6 --help
```
...
```bash
python course/day-02/lab-03/lab03_platform_probe.py en6
python course/day-02/lab-03/lab03_platform_probe.py en6 --json-out probe.json

# Instructor — clear space before toggling lidar
python course/day-02/lab-03/lab03_platform_probe.py en6 --lidar on
```

Merge probe JSON into the inspection bundle:

```bash
python course/day-02/lab-03/lab03_capture_inspection.py en6 --probe-json probe.json
```
