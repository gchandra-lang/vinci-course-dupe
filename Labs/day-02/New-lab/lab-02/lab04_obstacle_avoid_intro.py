#!/usr/bin/env python3
"""
Lab 4 — Go2 obstacle avoidance intro (visible stand + short forward move).
...
Usage:
  python course/day-02/New-lab/lab-02/lab04_obstacle_avoid_intro.py en6 --dry-run
  python course/day-02/New-lab/lab-02/lab04_obstacle_avoid_intro.py en6
  python course/day-02/New-lab/lab-02/lab04_obstacle_avoid_intro.py en6 --vx 0.3 --move-sec 3
  python course/day-02/New-lab/lab-02/lab04_obstacle_avoid_intro.py en6 --increment-move
  python course/day-02/New-lab/lab-02/lab04_obstacle_avoid_intro.py en6 --compare-free-avoid
"""
...
_DAY01 = _REPO_ROOT / "course" / "day-01"
...
def main() -> int:
    ...
    if not _wait_sportmodestate():
        print("FAIL: no rt/sportmodestate — run Lab 0/1 first")
        return 1
