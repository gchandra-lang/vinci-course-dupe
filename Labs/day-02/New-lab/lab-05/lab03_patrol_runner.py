...
Usage:
  python course/day-02/New-lab/lab-05/lab03_patrol_runner.py en6 --dry-run
  python course/day-02/New-lab/lab-05/lab03_patrol_runner.py en6
  python course/day-02/New-lab/lab-05/lab03_patrol_runner.py en6 --plan ../lab-04/patrol_plan.cone_course.json
  python course/day-02/New-lab/lab-05/lab03_patrol_runner.py en6 --out-dir ./run_team_a -y --validate
"""
...
def main() -> int:
    ...
    print(f"  ls {run_dir}")
    print(f"  python course/day-02/New-lab/lab-01/lab01_validate_run_folder.py {run_dir}")
    return 0
