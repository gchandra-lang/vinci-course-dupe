...
Usage:
  ...
  python course/day-02/New-lab/lab-06/lab04_tune_plan.py \\
    ../lab-04/patrol_plan.cone_course.json --out course/day-02/New-lab/lab-04/patrol_plan.tuned.json \\
    --leg 1 --dyaw 0.7 --leg 2 --dx 0.25

  # 2) Field trial run
  python course/day-02/New-lab/lab-06/lab04_field_trial.py en6 -y \\
    --plan course/day-02/New-lab/lab-04/patrol_plan.tuned.json \\
